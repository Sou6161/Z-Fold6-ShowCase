...
const NoteAssist = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="relative sm:mt-[5vh] lg:-mt-10 md:-ml-16  -ml-5 w-full min-h-screen  
    ...
    >
      ...
      <div className="relative z-20 max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        <div className="order-1 lg:order-2 space-y-8 text-white">
          ...
          <p
            ref={descriptionRef}
            className="text-lg lg:w-[45vw] 2xl:text-xl font-Questrial text-white/90 max-w-xl leading-relaxed 
