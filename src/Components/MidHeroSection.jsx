      ...
      >
        ...
        >
          <motion.span
            ...
            className="text-9xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-blue-500"
          >
            Galaxy AI
          </motion.span>
          ...
          <motion.h2
            ...
            initial={{ opacity: 0, y: 50, scale: 0.9 }}
            className="text-7xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white to-purple-300 drop-shadow-2xl"
          >
          ...
          <motion.p
            ...
            initial={{ opacity: 0, y: 50, scale: 0.9 }}
            className="mt-6 text-2xl font-light text-gray-300 max-w-3xl mx-auto"
          >
