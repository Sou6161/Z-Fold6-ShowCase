        ...
        >
          <div className="text-white space-y-6">
            <motion.h1
              ...
              className="text-5xl lg:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-emerald-400"
            >
        ...
        >
          ...
          <div className="text-white space-y-6">
            <motion.h1
              ...
              className="text-5xl lg:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-blue-400"
            >
              Zoom Map
            </motion.h1>
            <motion.p
        ...
        >
          <div className="max-w-3xl mx-auto text-white space-y-6">
            <motion.h1
              ...
              className="text-5xl lg:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-rose-400"
            >
