...
const SwitchToGalaxy = () => {
  ...
  return (
    <div className="relative -top-[14vh] md:-top-[17vh]  min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="relative w-full h-full px-4 [&_.swiper-button-next]:text-white [&_.swiper-button-next]:bg-white/10 [&_.swiper-button-next]:w-10 [&_.swiper-button-next]:h-10 [&_.swiper-button-next]:rounded-full [&_.swiper-button-next]:backdrop-blur-sm [&_.swiper-button-next]:transition-all [&_.swiper-button-next]:hover:bg-white/20 [&_.swiper-button-next]:after:content-[''] [&_.swiper-button-next]:after:w-3 [&_.swiper-button-next]:after:h-3 [&_.swiper-button-next]:after:border-t-2 [&_.swiper-button-next]:after:border-r-2 [&_.swiper-button-next]:after:border-white [&_.swiper-button-next]:after:rotate-45 [&_.swiper-button-next]:after:block [&_.swiper-button-prev]:text-white [&_.swiper-button-prev]:bg-white/10 [&_.swiper-button-prev]:w-10 [&_.swiper-button-prev]:h-10 [&_.swiper-button-prev]:rounded-full [&_.swiper-button-prev]:backdrop-blur-sm [&_.swiper-button-prev]:transition-all [&_.swiper-button-prev]:hover:bg-white/20 [&_.swiper-button-prev]:after:content-[''] [&_.swiper-button-prev]:after:w-3 [&_.swiper-button-prev]:after:h-3 [&_.swiper-button-prev]:after:border-t-2 [&_.swiper-button-prev]:after:border-l-2 [&_.swiper-button-prev]:after:border-white [&_.swiper-button-prev]:after:rotate-[-45deg] [&_.swiper-button-prev]:after:block [&_.swiper-pagination-bullet]:bg-white/50 [&_.swiper-pagination-bullet]:w-2 [&_.swiper-pagination-bullet]:h-2 [&_.swiper-pagination-bullet-active]:bg-blue-500 [&_.swiper-pagination-bullet-active]:w-3 [&_.swiper-pagination-bullet-active]:h-3">
        <Swiper
          effect="coverflow"
          grabCursor={true}
          centeredSlides={true}
